...
class WLASLDataset(Dataset):
    def __init__(self, json_path, videos_dir, split='train', num_frames=16):
...
def train():
    ...
    dataset = WLASLDataset(json_path="../WLASL/start_kit/WLASL_v0.3.json",
                           videos_dir="../WLASL/start_kit/videos", split='train')
    ...
    torch.save({'model_state_dict': model.state_dict(), 'label_map': dataset.label_map}, "asl_video_model2.pt")
